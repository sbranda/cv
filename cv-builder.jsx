    ...
    <div role="list" aria-label="Orden de las secciones del CV">
      {order.map((key, i) => (
        ...
        >
          ...
          <span className="text-[12.5px] text-stone-300 flex-1">{SECTION_LABELS[key] || key}</span>
        ...
        >
          ...
          <div className="mt-2 mb-3">
            ...
            <button
              ...
              className="mt-2 text-[10.5px] font-mono uppercase tracking-wider text-stone-500 hover:text-white transition inline-flex items-center gap-1"
            >
