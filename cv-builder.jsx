          ...
          <section className="mb-8">
            ...
            <Field label="Orden de las secciones">
              ...
              <button
                ...
                className="text-[10.5px] font-mono uppercase tracking-wider text-white hover:text-white transition mt-2 disabled:opacity-30 disabled:cursor-default disabled:hover:text-white"
              >
                ↺ Restablecer orden
              </button>
              ...
              <div className="flex items-center gap-3">
                {data.experiencia.filter((e) => e.puesto || e.empresa).length >= 2 && (
                  <button
                    ...
                    className="text-[10.5px] font-mono uppercase tracking-wider text-white hover:text-white transition disabled:opacity-40 inline-flex items-center gap-1"
                  >
                    {gapCheckLoading ? (
                      <Loader2 size={11} className="animate-spin" aria-hidden="true" />
                    ) : (
