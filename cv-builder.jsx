...
function ImportModal({ open, onClose, onImport, importing, error }) {
  ...
  return (
    <div className="fixed inset-0 z-40 bg-black/70 backdrop-blur-sm flex items-center justify-center p-6 no-print">
      <div className="bg-stone-900 border border-stone-800 rounded-lg w-full max-w-md p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <section className="mb-8">
            ...
            <Field label="Orden de las secciones">
              ...
              <p className="text-[10px] text-stone-600 mt-1.5 leading-relaxed">
                Arrastrá desde el ícono para reordenar. No aplica a Moderno, Ejecutivo, Académico y
                Ventas/Marketing — su diseño en columnas o su secuencia académica/de métricas depende de un
                orden fijo.
              </p>
            </Field>
          </section>
